...
**When runninng scans or take measurement**: 
For scans, whatever folder name you decide to use, it will be saved under home/user/tmpData/AI_scan. 
For 'Capture an image' or 'Take measurement' requests, this will be saved under home/user/tmpData/AI_scan/measurements.
