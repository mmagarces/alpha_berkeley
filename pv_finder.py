...
HARDCODED_PV_TABLE = {
    "motors": [
        ProcessVariable(
            ...
            description="Main beamline motor - controls vertical beam position",
            category="motor",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:BM:01:X",
            description="Main beamline motor - controls horizontal beam position", 
            category="motor",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SM:01:THETA",
            description="Sample rotation motor - controls sample angle",
            category="motor",
            units="degrees"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SM:01:Z",
            description="Sample vertical position motor",
            category="motor", 
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SM:01:PHI",
            description="Sample azimuthal rotation motor",
            category="motor",
            units="degrees"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:DM:01:Y",
            description="Detector vertical position motor",
            category="motor",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:DM:01:X", 
            description="Detector horizontal position motor",
            category="motor",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:DM:01:Z",
            description="Detector distance motor - controls sample-to-detector distance",
            category="motor",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SM:01:CHI",
            description="Sample chi angle motor for crystallography",
            category="motor",
            units="degrees"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SM:01:OMEGA",
            description="Sample omega rotation motor for crystallography",
            category="motor", 
            units="degrees"
        )
    ],
    "detectors": [
        ...
        ProcessVariable(
            pv_name="ALS:SR:ES:SC:01:VALUE",
            description="Scintillation counter detector",
            category="detector",
            units="counts"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:PMT:01:VALUE",
            description="Photomultiplier tube detector",
            category="detector",
            units="V"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:CCD:01:IMAGE",
            description="CCD camera detector - captures 2D images",
            category="detector",
            units="pixels"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SDD:01:SPECTRUM",
            description="Silicon drift detector - energy dispersive spectroscopy",
            category="detector",
            units="counts"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:GE:01:SPECTRUM",
            description="Germanium detector for high-resolution spectroscopy",
            category="detector",
            units="counts"
        )
    ],
    "beamline_controls": [
        ProcessVariable(
            pv_name="ALS:SR:ES:SLIT:01:Y:GAP",
            description="Vertical slit gap control",
            category="beamline_control",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SLIT:01:X:GAP",
            description="Horizontal slit gap control", 
            category="beamline_control",
            units="mm"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:MONO:01:ENERGY",
            description="Monochromator energy control",
            category="beamline_control",
            units="eV"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:MONO:01:ANGLE",
            description="Monochromator angle control",
            category="beamline_control",
            units="degrees"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:FLT:01:POSITION",
            description="Filter wheel position control",
            category="beamline_control",
            units="position"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:SHUTTER:01:STATE",
            description="Beam shutter control (open/closed)",
            category="beamline_control",
            units="state"
        )
    ],
    "environmental": [
        ProcessVariable(
            pv_name="ALS:SR:ES:CHAMBER:01:PRESSURE",
            description="Sample chamber pressure",
            category="environmental",
            units="Torr"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:CHAMBER:01:TEMPERATURE",
            description="Sample chamber temperature",
            category="environmental",
            units="K"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:HEATER:01:SETPOINT",
            description="Sample heater temperature setpoint",
            category="environmental",
            units="K"
        ),
        ProcessVariable(
            pv_name="ALS:SR:ES:COOLER:01:SETPOINT",
            description="Sample cooler temperature setpoint",
            category="environmental",
            units="K"
        )
    ]
